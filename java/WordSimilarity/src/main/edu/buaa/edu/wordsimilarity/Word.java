...
public class Word {
     ...
     */
    private Map<String, List<String>> relationSymbolPrimitives = new HashMap<String, List<String>>();
     ...
     * DOCUMENT ME!
     *
     * @param structuralWords
     *            DOCUMENT ME!
     */
    public void setStructruralWords(List<String> structuralWords) {
        this.structuralWords = structuralWords;
    }
    ...
    public void addRelationSimbolPrimitive(String key,String value){
        List<String> list = relationSymbolPrimitives.get(key);

        if (list == null) {
            list = new ArrayList<String>();
            list.add(value);
            relationSymbolPrimitives.put(key, list);
        } else {
            list.add(value);
        }
    }
    ...
    public Map<String, List<String>> getRelationSimbolPrimitives() {
        return relationSymbolPrimitives;
    }
}
